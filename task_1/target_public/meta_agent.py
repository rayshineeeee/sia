...
if os.path.exists('target_agent.py'):
    logger.info("Removing existing target_agent.py file")
    os.remove('target_agent.py')
...
3. The target_agent.py should log its execution trajectory (messages, tool calls, and results) to a JSON file for debugging and analysis purposes.
"""
